$(function() {
    ...
    //設定resize 計時器
    var resizeTimer;
    _window.bind("load resize orientationchange", function(event) {
        ...
        resizeTimer = setTimeout(function() {
            ...
            if (ww < wwSmall) {
                ...
                liHasChild.off().on('click', function(e) {
                    ...
                    $('.sidebar .menu .hasChild .hasChild>ul').show(); //第三層關閉
    ...
    _searchCtrl.off().on('click', function(e) {
        if (!search_mode) {
            $('.m_search').stop(true, true).slideDown('400', 'easeOutQuint');
